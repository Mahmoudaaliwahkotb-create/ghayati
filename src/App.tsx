...
import { BookingModal, BookingConfirmationPayload } from './components/BookingModal';
...
export default function App() {
  ...
  const handleConfirmBooking = (payload: BookingConfirmationPayload) => {
    setConfirmedBooking({
      ...payload,
      ...
      <div className="bg-surface-container border-b border-outline-variant/60 py-2 sticky top-20 z-40 shadow-xs">
        <div className="max-w-7xl mx-auto px-margin flex items-center justify-between gap-2 overflow-x-auto no-scrollbar">
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar py-0.5">
            ...
            {/* Teacher Registration Screen Button */}
            <button
            ...
            >
              <span className="material-symbols-outlined text-xs text-emerald-600">how_to_reg</span>
              <span>٩. تسجيل معلم جديد (Supabase)</span>
            </button>
      ...
      <div className="flex-1 flex flex-col">
        ...
        {activeTab === 'booking_confirmed' && (
          <BookingConfirmedView
            setActiveTab={handleNavigateTab}
            onOpenBookingModal={() => handleOpenBookingModal()}
            selectedTeacher={confirmedBooking?.teacher || selectedTeacher}
            bookingInfo={confirmedBooking}
          />
        )}
        ...
        {activeTab === 'teacher_register' && (
          <TeacherRegistrationView setActiveTab={handleNavigateTab} />
        )}
      </div>
