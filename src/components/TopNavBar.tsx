            ...
            {showProfileMenu && (
              <div className="absolute left-0 mt-2 w-64 bg-surface-container-lowest border border-outline-variant rounded-2xl shadow-xl p-3 z-50 text-right animate-in fade-in slide-in-from-top-2">
                ...
                <div className="space-y-1 text-body-sm font-body-sm text-on-surface-variant">
                  ...
                  <button
                    onClick={() => { setActiveTab('teacher_register'); setShowProfileMenu(false); }}
                    className="w-full text-right p-2 rounded-lg hover:bg-surface-container-low text-on-surface hover:text-primary flex items-center justify-between border-t border-outline-variant/50 pt-2.5 mt-1"
                  >
                    <span className="flex items-center gap-1.5 font-semibold">
                      <span className="material-symbols-outlined text-base text-primary">how_to_reg</span>
                      <span>تسجيل معلم جديد (انضم إلينا)</span>
                    </span>
